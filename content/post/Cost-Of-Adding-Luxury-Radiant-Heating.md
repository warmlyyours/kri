...
{{< postImage "Smart Guide" "/img/luxuryHeating/IP1519351-R1-(2)-(1).png" "/img/luxuryHeating/IP1519351-R1-(2)-(1).png" >}}
...
{{< postImage "Cutting cables" "/img/luxuryHeating/floor-sensor-v2.png" "/img/luxuryHeating/floor-sensor-v2.png" >}}
...
{{< postImage "Cut and Turn Technology" "/img/luxuryHeating/cut-mesh.png" "/img/luxuryHeating/cut-mesh.png" >}}
...
{{< postImage "Proper Spacing" "/img/luxuryHeating/free-form-3.png" "/img/luxuryHeating/free-form-3.png" >}}
...
{{< postImage "Smiling Architect Having a Phone Call" "/img/luxuryHeating/smiling-architect-having-a-phone-call-6DJWV7H.jpg" "/img/luxuryHeating/smiling-architect-having-a-phone-call-6DJWV7H.jpg" >}}
...
Noone likes crawling around and counting every inch so the [On-Site SmartFit](https://www.warmlyyours.com/en-US/services/measuring) service really aims, in all seriousness, to size the space and tally up the numbers for you. Warmlyyours measures the dimensions of up to three rooms for $250, and you get accurate measurements so WarmlyYours can fit the best floor heating roll or mat for the area. The Measuring Service will cost $10 for each additional room and $3.50 per mile driven if you're over 100 miles from WarmlyYours HQ.

In addition, installation guidance over a video call can be requested. WarmlyYours technicians provide [Remote SmartGuide](https://www.warmlyyours.com/en-US/services/floor-heating/remote-project-support). The cost of this service is $75 for the first hour and an additional $75/hour thereafter. This service puts a professional tradesman on your team who’ll guide you through the installation process. Once you’ve tried installing with remote supervision, you’ll wonder how you ever managed without one.

[On-Site SmartGuide](https://www.warmlyyours.com/en-US/services/floor-heating/remote-project-support) costs $399 for a one-day supervision with a time limit of 6 hours. Radiant heating products come in the form of cables, mats, and towel warmers all of which are the expertise of a WarmlyYours technician so that you don’t have to install them separately. This service serves our immediate local community best which remains within a 100 mile radius. Additional travel fees include $3.50 per mile over 100 miles, $499 for an overnight stay, and if an extensive stay is required then the fee will be calculated at the quoting stage.
...
{{< postImage "Energy Use Calculator" "/img/luxuryHeating/energy-use-calculator-9d6312.jpeg" "/img/luxuryHeating/energy-use-calculator-9d6312.jpeg" >}}
### Operating Costs
...
Instant Quote: [www.warmlyyours.com/my_projects/new](https://www.warmlyyours.com/en-US/floor-heating/quote-builder)
Energy Use Calculator: [www.warmlyyours.com/floor-heating/cost-calculator](https://www.warmlyyours.com/en-US/floor-heating/cost-calculator)
Heat Loss Calculator: [www.warmlyyours.com/tools/heatloss-calculato…](https://www.warmlyyours.com/en-US/floor-heating/heatloss-calculator)
Average Electricity Cost: https://www.electricitylocal.com/states/illinois/lake-zurich/
