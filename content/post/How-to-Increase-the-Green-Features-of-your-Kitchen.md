...
tags:
  ...
  - Flooring
---
## ![How to Increase the Green Features of your Kitchen](/img/greenFeatures/how-to-increase-the-green-features-of-your-kitchen.jpg)
...
## ![Energy Star Appliances](/img/greenFeatures/pastedimage0.png)
...
## ![Radiant floor heating thermostat and lifestyle photo](/img/greenFeatures/nspire-touch-wifi-floor-heating-thermostat-lifestyle-3a9620.jpeg)
...
Radiant heating systems gradually send warmth beneath the floor over the span of time you program with a [WarmlyYours nSpire Touch Wifi Thermostat](https://www.warmlyyours.com/en-US/products/code/UWG4-4999). A programmable thermostat relies on its energy-saving ability to activate the heating element when you need and shut off when you don’t. Your radiant heating system can be programmed to turn on during the times when you’re meal-prepping, cooking, and cleaning.
...
![Lifestyle of a Kitchen with Electric Radiant Countertop Heating](/img/greenFeatures/lifestyle-of-a-kitchen-with-electric-radiant-countertop-heaters-2b8912.jpeg)
...
Similarly, CFL lighting is more efficient than incandescent bulbs, lasting up to 10 times longer. Additionally, compact fluorescent light bulbs are extremely versatile and can be used in recessed fixtures, table lamps, track lighting, ceiling fixtures, and porch lights.
Now, three-way CFL bulbs and dimmable ones are also available for use with dimmer switches.
